...
/**
 * BruteForce menetelmällä sokkelon läpikäyntiä. Tarkoituksena olla
 * mahdollisimman tehoton, jotta saadaan vertailukohtaa oikeisiin pathfinding
 * algoritmeihin.
 *
 * @author Cobrelli
 */
public class BruteForce {
    ...
    /**
     * Konstruktoi uuden BruteForce luokan jolla voidaan ajaa erilaisia
     * sokkeloita lävitse ja tarkastella selvitysten nopeutta.
     */
    public BruteForce() {
    }
     ...
     * johonkin suuntaan ja tarkistaa onko siirto validi, jos ei niin
     * seuraavalla kierrokselle haetaan uusi paikka. Oletuksena sokkelossa on
     * että se on läpäistävissä, muuten se jää looppaamaan. Suoritus päättyy kun
     * saavutetaan maaliruutu.
     *
