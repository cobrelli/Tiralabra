...
/**
 * MinimiKeko, jota käytetään priorityqueuen sijaan Dijkstran ja A*
 * algoritmeissa.
 *
 * @author Cobrelli
 */
public class MinimiKeko {
    ...
    /**
     * Sijoittaa uuden olion kekoon. Olio sijoitetaan viimeiseksi ja tämän
     * jälkeen sitä nostellaan ylöspäin niin kauan ettei sen yläpuolella ole
     * sitä itseään suurempia olioita.
     *
    ...
    /**
     * Poistaa keon pienimmän eli päällimmäisen paikka olion ja palauttaa
     * viitteen siihen.
     *
    ...
    /**
     * Heapifyn apumetodi jolla vertaillaan mikä on pienin vertailtavista
     * alkioista ja palautetaan se.
     *
     * @param l Kertoo vasemman lapsen sijainnin keossa.
     * @param r Kertoo oikean lapsen sijainnin keossa.
     * @return Palauttaa pienimmän vertailtavan alkion.
     */
    private int vertailePienin(int l, int r) {
        int pienin = l;

        if (alkiot[l].compareTo(alkiot[r]) > 0 || alkiot[r].compareTo(alkiot[pienin]) < 0) {
            pienin = r;
        }
